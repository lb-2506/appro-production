...
export default function TeamHomeComponent() {
  return (
    ...
    >
      <div className="bg-[#F5F5F5] max-w-[1240px] w-[90%] mx-auto rounded-[20px] p-6 sm:p-10 lg:p-12">
        <div className="grid grid-cols-2 gap-10">
          ...
          <div className="rounded-[18px]ring-1 ring-black/5 p-6 sm:p-10 flex flex-col justify-between">
            ...
            <div className="mt-10 max-w-[48ch] text-black/70">
              <p className="text-[15px] leading-relaxed">
                Nous croyons que les meilleurs résultats naissent de la
                collaboration. C’est pourquoi nous travaillons en étroite
                collaboration les uns avec les autres afin de garantir que
                chaque projet atteigne vos objectifs et dépasse vos attentes.
              </p>

              <a
                href="#contact"
                className="mt-6 inline-flex items-center gap-2 rounded-full bg-black text-white px-5 py-2.5 text-sm font-medium shadow/30 shadow-black/30 hover:shadow-black/50 transition-shadow"
              >
                Contactez-nous ↗
              </a>
            </div>
